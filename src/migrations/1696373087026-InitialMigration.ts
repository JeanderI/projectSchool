...
export class InitialMigration1696373087026 implements MigrationInterface {
    name = 'InitialMigration1696373087026'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "listening" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying NOT NULL, "description" character varying NOT NULL, "start" character varying, "end" character varying, "text" character varying NOT NULL, "help" character varying, "url" character varying NOT NULL, "userId" uuid, CONSTRAINT "PK_385522e31afc7cd2f023ce24ee9" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "photo" character varying, "username" character varying NOT NULL, "email" character varying NOT NULL, "password" character varying NOT NULL, CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "pronunciation" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying NOT NULL, "description" character varying NOT NULL, "start" character varying, "end" character varying, "text" character varying NOT NULL, "help" character varying, "url" character varying NOT NULL, "userId" uuid, CONSTRAINT "PK_03d09e54a54345f930fc5288b11" PRIMARY KEY ("id"))`);
